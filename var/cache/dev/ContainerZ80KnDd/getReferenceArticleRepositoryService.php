 ...
 */
class getReferenceArticleRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReferenceArticleRepository' shared autowired service.
     *
     * @return \App\Repository\ReferenceArticleRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReferenceArticleRepository.php';

        return $container->privates['App\\Repository\\ReferenceArticleRepository'] = new \App\Repository\ReferenceArticleRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
