 ...
 */
class getHumeurRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\HumeurRepository' shared autowired service.
     *
     * @return \App\Repository\HumeurRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'HumeurRepository.php';

        return $container->privates['App\\Repository\\HumeurRepository'] = new \App\Repository\HumeurRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
