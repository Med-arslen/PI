 ...
 */
class getPlanningEtudeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PlanningEtudeRepository' shared autowired service.
     *
     * @return \App\Repository\PlanningEtudeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PlanningEtudeRepository.php';

        return $container->privates['App\\Repository\\PlanningEtudeRepository'] = new \App\Repository\PlanningEtudeRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
