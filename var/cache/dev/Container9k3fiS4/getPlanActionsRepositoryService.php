 ...
 */
class getPlanActionsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PlanActionsRepository' shared autowired service.
     *
     * @return \App\Repository\PlanActionsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PlanActionsRepository.php';

        return $container->privates['App\\Repository\\PlanActionsRepository'] = new \App\Repository\PlanActionsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
