 ...
 */
class getSortieAIRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SortieAIRepository' shared autowired service.
     *
     * @return \App\Repository\SortieAIRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SortieAIRepository.php';

        return $container->privates['App\\Repository\\SortieAIRepository'] = new \App\Repository\SortieAIRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
