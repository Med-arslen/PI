 ...
 */
class getCarnetRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CarnetRepository' shared autowired service.
     *
     * @return \App\Repository\CarnetRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CarnetRepository.php';

        return $container->privates['App\\Repository\\CarnetRepository'] = new \App\Repository\CarnetRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
