...
/* back/base.html.twig */
class __TwigTemplate_d76de574b258c4f84b30b94d0c764b3e extends Template
{
...
<!-- ======= SAME HEADER STRUCTURE – BACK ROUTES ONLY ======= -->
  ...
  <div class=\"container-fluid container-xl position-relative d-flex align-items-center\">
    ...
    <nav id=\"navmenu\" class=\"navmenu\">
      <ul>
        ...
        <li><a href=\"";
        // line 44
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("back_course_details");
        yield "\">Etude</a></li>
        <li><a href=\"";
        // line 45
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("back_blog");
        yield "\">Note</a></li>
        <li><a href=\"";
        // line 46
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("back_instructors");
        yield "\">Projets</a></li>
        <li><a href=\"";
        // line 47
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("back_courses");
        yield "\">Parcours</a></li>
        ...
        <li class=\"dropdown\">
          ...
          <ul>
            <li><a href=\"";
        // line 55
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("back_blog_details");
        yield "\">Emplois</a></li>
            <li><a href=\"";
        // line 56
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("back_events");
        yield "\">Défis</a></li>
            <li><a href=\"";
        // line 57
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("back_instructor_profile");
        ...
        <li><a href=\"";
        // line 61
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("back_contact");
        yield "\">Contact</a></li>
        <li><a href=\"";
        // line 62
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("back_pricing");
        yield "\">Pricing</a></li>
        <li><a href=\"";
        // line 63
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("back_about");
        yield "\">About</a></li>
      </ul>
    ...
    <a class=\"btn-getstarted\" href=\"#\">Admin</a>
...
";
    ...
    {
        return array (  351 => 103,  329 => 76,  307 => 28,  285 => 8,  262 => 7,  249 => 104,  247 => 103,  242 => 101,  236 => 98,  232 => 97,  228 => 96,  224 => 95,  208 => 82,  201 => 77,  199 => 76,  183 => 63,  179 => 62,  175 => 61,  168 => 57,  164 => 56,  160 => 55,  149 => 47,  145 => 46,  141 => 45,  137 => 44,  133 => 43,  125 => 38,  121 => 37,  111 => 29,  109 => 28,  104 => 26,  98 => 23,  94 => 22,  90 => 21,  86 => 20,  75 => 12,  71 => 11,  65 => 8,  61 => 7,  53 => 1,);
    }
...
<head>
  ...
  <title>{% block title %}MentorAI | Admin{% endblock %}</title>
...
<header id=\"header\" class=\"header d-flex align-items-center sticky-top\">
  <div class=\"container-fluid container-xl position-relative d-flex align-items-center\">
    ...
    <a href=\"{{ path('back_home') }}\" class=\"logo d-flex align-items-center me-auto\">
      <img src=\"{{ asset('assets/img/123.png') }}\" alt=\"MentorAI Admin Logo\">
    </a>

    <nav id=\"navmenu\" class=\"navmenu\">
      <ul>
        <li><a href=\"{{ path('back_home') }}\">Home</a></li>
        <li><a href=\"{{ path('back_course_details') }}\">Etude</a></li>
        <li><a href=\"{{ path('back_blog') }}\">Note</a></li>
        <li><a href=\"{{ path('back_instructors') }}\">Projets</a></li>
        <li><a href=\"{{ path('back_courses') }}\">Parcours</a></li>
        ...
        <li class=\"dropdown\">
          ...
          <ul>
            <li><a href=\"{{ path('back_blog_details') }}\">Emplois</a></li>
            <li><a href=\"{{ path('back_events') }}\">Défis</a></li>
            <li><a href=\"{{ path('back_instructor_profile') }}\">Instructor Profile</a></li>
          </ul>
        </li>

        <li><a href=\"{{ path('back_contact') }}\">Contact</a></li>
        <li><a href=\"{{ path('back_pricing') }}\">Pricing</a></li>
        <li><a href=\"{{ path('back_about') }}\">About</a></li>
      </ul>
...
", "back/base.html.twig", "C:\\Users\\user\\Desktop\\mentorai\\templates\\back\\base.html.twig");
    }
}
